...
class MainSolution():
    def __init__(self):
        self.image = cv.imread("/Users/glebklyga/PCG_LABS/PCG_LABS/LAB_3/Code/Images/g.jpg")
        self.imgray = None
        self.trsh1 = None
        self.trsh2 = None
...
class MainApp():
    def __init__(self, master):
        ...
        self.button7 = Button(self.frame, text="Gradient", font=("Arial", 12), bg="white",
                                command=self.gradient)
        self.button7.grid(row=4, column=0, pady=10)

        self.button8 = Button(self.frame, text="Top Hat", font=("Arial", 12), bg="white",
                                command=self.top_hat)
        self.button8.grid(row=4, column=1, pady=10)

        self.button9 = Button(self.frame, text="Black Hat", font=("Arial", 12), bg="white",
                                command=self.black_hat)
        self.button9.grid(row=5, column=0, pady=10)

        self.button10 = Button(self.frame, text="Erosion", font=("Arial", 12), bg="white",
                                command=self.erosion)
        self.button10.grid(row=5, column=1, pady=10)

        self.button11 = Button(self.frame, text="Dilation", font=("Arial", 12), bg="white",
                                command=self.dilation)
        self.button11.grid(row=6, column=0, pady=10)

        self.button12 = Button(self.frame, text="Houk", font=("Arial", 12), bg="white",
                                command=self.houk)
        self.button12.grid(row=6, column=1, pady=10)

        self.button13 = Button(self.frame, text="Sobel", font=("Arial", 12), bg="white",
                                command=self.sobel)
        self.button13.grid(row=7, column=0, pady=10)

        self.button14 = Button(self.frame, text="Laplacian", font=("Arial", 12), bg="white",
                                command=self.laplacian)
        self.button14.grid(row=7, column=1, pady=10)

        self.button15 = Button(self.frame, text="Furie", font=("Arial", 12), bg="white",
                                command=self.furie)
        self.button15.grid(row=8, column=0, pady=10)

        self.button16 = Button(self.frame, text="Opening", font=("Arial", 12), bg="white",
                                command=self.opening)
        self.button16.grid(row=8, column=1, pady=10)

        self.button17 = Button(self.frame, text="Closing", font=("Arial", 12), bg="white",
                                command=self.closing)
        self.button17.grid(row=9, column=0, pady=10)

        self.button18 = Button(self.frame, text="Exit", font=("Arial", 12), bg="white",
                                command=self.master.destroy)
        self.button18.grid(row=9, column=1, pady=10)
